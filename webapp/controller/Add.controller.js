sap.ui.define(
  ...
  function (BaseController, JSONModel, MessageBox, MessageToast, Fragment) {
    ...
    return BaseController.extend("tcs.fin.ap.controller.Add", {
      ...
      // when user press enter key load the auto data
        ...
        oDataModel.read("/ProductSet('" + this.prodId + "')", {
          success: function (data) {
            ...
            that
              ...
              .byId("prodImage")
              .setSrc(
                "/sap/opu/odata/sap/ZTEST_ODATA_SRV/ProductImgSet('" + that.prodId + "')/$value"
              );
          },
          error: function () {
            that.setMode("Create");
